...
export default class ClassesControllers {
    ...
    async create(req: Request, res: Response) {
        ...
        try {
            ...
            const classSchedule = schedule.map((schedulteItem: ScheduleItem) => {
                return {
                    class_id,
                    week_day: schedulteItem.week_day,
                    from: convertHourToMinutes(schedulteItem.from),
                    to: convertHourToMinutes(schedulteItem.to)
                }
            })
